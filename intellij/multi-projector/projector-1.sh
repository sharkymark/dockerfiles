...
"$JAVA_BIN" \
  ...
  -Didea.paths.selector=IntelliJIdea2021.3 \
  "-Djb.vmOptionsFile=$VM_OPTIONS_FILE" \
  -Didea.properties.file=/home/coder/.projector/configs/IntelliJ_2/idea.properties \
...
# This was the original launch for idea.sh. Above is my modification for projector.
#"$JAVA_BIN" \
#  -classpath "$CLASSPATH" \
#  ${VM_OPTIONS} \
#  "-XX:ErrorFile=$HOME/java_error_in_idea_%p.log" \
